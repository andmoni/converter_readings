...
# на будущее: сделать доступным из программы для редактирования.
...
for pretext in pretexts_l:
    pretexts.append(' {} '.format(pretext))
    pretexts.append('{} '.format(pretext.capitalize()))
...
class WidgetConverterText(QWidget, Ui_WidgetConverterText):
    ...
    def _convert(self, ch, text):
        ...
        # получаем словарь для конвертирования глаголов
        dict_words = convert_dictionary_for_conversion(self.replacement_words)
        # цикл по глаголам (пользовательский словарь)
